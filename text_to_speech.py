def text_to_speech_process(text):
    # langkah 0 : hapus semuanya di folder audio
    # langkah 1 : generate audio dari tacotron
    # langkah 2 : save file audio di lokal
    # langkah 3 : dapatkan directory file nya
    # langkah 4 : return directory file nya
    return text
